...
<body id="home" class="homepage">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                 ...
                 <li class="scroll"><a href="gallery.php">GALLERY</a></li>
                      <li class="scroll  active"><a href="about.php">ABOUT AtoZ</a></li>
    ...
    <p class="text-center wow fadeInDown">Aim to protect proficinet professional pest control services</p>
            </div>
                ...
                <div class="col-sm-12 wow fadeInRight">
                    <h3 class="column-title">AtoZ Pest control and Facilities Management</h3>
                      ...
                      <p>AtoZ pest control and facilities management has started the on 1-2-2016 by a professionals who have expertised in the area of pest control and facilities mangement.</p>
<p>The organiztion has started with a motive of environment friendly treatments and products and thus the products of A to Z are completely based on Bayer Inc (Internation company from germany)</p>
                    <p>We aim to protect proficient professional pest control services by offering the most thorough and proven methods to eliminate pests in & around  your homes/offices.</p>

                    <p>Working together with you , our aim is to provide a safe & long term pest free environment to live in.</p>
