...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="images/logo.png" alt="logo"></a><br>
                ...
                <div class="collapse navbar-collapse navbar-right">
                   ...
                   <li class="scroll"><a href="gallery.php">GALLERY</a></li>
                        <li class="scroll"><a href="about.php">ABOUT AtoZ</a></li>
                      <!--  <li class="scroll"><a href="#meet-team">Team</a></li>!-->
                  <!--      <li class="scroll"><a href="#pricing">Pricing</a></li>!-->
                        <li class="scroll"><a href="service-area.php">SERVICE SEGMENTS</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2><span style="color:green;">KEEP THE PEST OUT</span></h2>

                                    <p>PEST CONTROL & FACILITIES MANAGEMENT</p>

                                    <h4><span style="color:green;">PEST CONTROL EXPERTS YOU CAN DEPEND ON</span></h4>
                                    <a class="btn  btn-lg" href="#" style="background-color:green;color:white;">CHECKOUT MORE DETAILS</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2><span style="color:green;">Eco-friendly pest products</span></h2>
                                    <p>Protect your surroundings from termites , insects , snames , rodent , mosquitoes and other crawling insects. </p>
    ...
    <section id="cta" class="wow fadeIn">
        <div class="container">
            <div class="row">
                <div class="col-sm-9">
                    <h2 style="color:green;">DO YOU HAVE PEST PROBLEM ?</h2>
                    <h4><span style="color:black;">FOR PROMOPT ACTION</span> </h4>
                    <h4><span style="color:black;">CALL : 703 444 6552</span> </h4>
                </div>
                <div class="col-sm-3 text-right">
                          <img src="images/eco-friendly.png" alt="logo">
                </div>
            </div>
        </div>
    </section><!--/#cta-->
  ...
  <!--  <section id="features">
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
              <!--  <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span></span></h2>
              ...
              !-->  <img class="img-responsive wow fadeIn" src="images/cta2/cta2-img.png" alt="" data-wow-duration="300ms" data-wow-delay="300ms">
                 <a class="btn btn-primary btn-lg" href="#">SUBMIT YOUR NEED ?</a>
            </div>
        </div>
    </section>
    ...
    <section id="services" >
        <div class="container">
            ...
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">WHY US ?</h2>
            <!--    <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
          !-->  </div>
                ...
                <div class="features">
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body"><br>
                                <h4 class="media-heading">Progressive Pest control</h4>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body"><br>
                                <h4 class="media-heading">24x Customer Support</h4>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body"><br>
                                <h4 class="media-heading">Quality products</h4>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body"><br>
                                <h4 class="media-heading">Eco-Friendly treatments</h4>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body"><br>
                                <h4 class="media-heading">Wide Service Segments</h4>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="500ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body"><br>
                                <h4 class="media-heading">Eco-Friendly products</h4>
  ...
  <!--  <section id="work-process">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">TREATMENT WORKFLOW</h2>
    ...
    <section id="animated-number">
        <div class="container">
            <div class="section-header">
                <h4 class="section-title text-center wow fadeInDown">A-Z OFFERS SERVICES BEYOND COMPARE</h2>

            </div>
<ul>
   <li>Our integrated pest control management includes a detailed plan of action & a scheduled of various treatments to be rendered.</li>
    <li>Our highly trained staff make a thorough inspection of the site before & after the service has been rendered</li>
  <li>We provide pre & post construction anti-termite treatments</li>
  <li>All our treatment plans are environment friendly.</li>
          ...
          <!--  <div class="row text-center">
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
                        ...
                        <strong>SERVICE SEGMENTS</strong>
                    </div>
                </div>!-->
            </div>
        </div>
  ...
  <!--  <section id="contact">
        <div id="google-map" style="height:650px" data-latitude="11.2403876" data-longitude="75.7862217"></div>
                ...
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-8">
                        <div class="contact-form">
                            ...
                            <address>
                              <strong>A to Z Pest Control & Facilities Management</strong><br>
                              18/920D, LAKSHMI TOWER. OPP Suryakanthi Kalyana mandapam.<br>
                              Thali,Chalappuram(P.O) Calicut - 673002<br>
                                  Kerala , India <br>
                              <abbr title="Phone">P:</abbr>+91 7034446552 , +91 7034446553
                            </address>
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2016 AtoZ. Powered by <a target="_blank" href="http://welkinwits.com/" title="">WelkinWits</a>
                </div>
                <div class="col-sm-6">
                    <ul class="social-icons">
                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
