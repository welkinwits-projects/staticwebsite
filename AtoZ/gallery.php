        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                 ...
                 <li class="scroll  active"><a href="gallery.php">GALLERY</a></li>
          ...
          <div class="container">
              ...
              <div class="text-center">
                  <ul class="portfolio-filter">
                      <li><a class="active" href="#" data-filter="*">All Pest controll</a></li>
                      <li><a href="#" data-filter=".creative">Home and Office</a></li>
                      <li><a href="#" data-filter=".corporate">Commercial buildings</a></li>
                      <li><a href="#" data-filter=".portfolio">Food industry</a></li>
                  </ul><
              </div>
